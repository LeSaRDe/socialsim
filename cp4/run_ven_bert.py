...
parser = argparse.ArgumentParser(description='Apply Venezuela BERT Models')
parser.add_argument('--model', type=str, help='Path to model .bin file')
parser.add_argument('--type', type=str, help='Either the string "nar" for narrative or "stance" for stance')
parser.add_argument('--input', type=str, help='Input csv file with "comment" and "id" columns')
parser.add_argument('--dir', type=str, help='Directory containing /tmp/classes.txt for either stance or narrative')
